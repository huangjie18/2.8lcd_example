...
{	  	 
	...
	if(EXTI_GetITStatus(((uint32_t)0x00008)) != RESET) 
		...
		if(BIT_Count>1&&BIT_Count<10)
			{	  
			tempdata>>=1;
			if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),((uint16_t)0x0004)))
				{
				tempdata|=0x80;
				parity++;
				}   
			...
			{
			if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),((uint16_t)0x0004)))parity|=0x80;
			}	   
		if(BIT_Count==11)
			{
			BIT_Count=parity&0x7f;
			if(((BIT_Count%2==0)&&(parity&0x80))||((BIT_Count%2==1)&&(parity&0x80)==0))
				...
				if(BIT_Count<15)PS2_Status++;    
				BIT_Count=PS2_Status&0x30;	     
				switch(BIT_Count)
					{
					case 0X00:
						PS2_Dis_Data_Report();
...
{
	PS2_Set_Int(0);   
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->CRL&=0XFFFF0FFF;((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->CRL|=0X00003000;};
...
void PS2_En_Data_Report(void)
{
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->CRL&=0XFFFF0FFF;((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->CRL|=0X00008000;}; 
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->CRL&=0XFFFFF0FF;((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->CRL|=0X00000800;}; 
	GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0008));    
	GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0004)); 
	PS2_Set_Int(1);   
}
...
void PS2_Set_Int(u8 en)
{
	((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->PR=1<<3;  
	if(en)((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->IMR|=1<<3;
    else ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->IMR&=~(1<<3);
}
...
u8 Wait_PS2_Scl(u8 sta)
{
	u16 t=0;
	sta=!sta;
	while(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),((uint16_t)0x0008))==sta)
	{
		Delay(1);
		t++;
		if(t>1600)return 1;
...
u8 PS2_Get_Byte(void)
{
	...
	while(1)
	{
		...
		if(PS2_Status&0x80)
		{
			...
			PS2_Status&=0x70;
			break;	
		}else if(t>550||PS2_Status&0x40)break;
	}
	PS2_En_Data_Report();
	return temp;    
}	    
...
u8 PS2_Send_Cmd(u8 cmd)
{
	...
	PS2_Set_Int(0);   
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->CRL&=0XFFFF0FFF;((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->CRL|=0X00003000;};
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->CRL&=0XFFFFF0FF;((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->CRL|=0X00000300;};
	GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0008));
	Delay(12);
	GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0004));
	Delay(1);
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->CRL&=0XFFFF0FFF;((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->CRL|=0X00008000;};
	GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0008));
	if(Wait_PS2_Scl(0)==0)
	   {									  
			...
			if(cmd&0x01)
			  {
			   GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0004));
			   high++;
			  }else GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0004));   
			cmd>>=1;
			
			Wait_PS2_Scl(1);
			Wait_PS2_Scl(0);
		   }
		if((high%2)==0)GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0004));
		   else GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0004));
		Wait_PS2_Scl(1); 
		Wait_PS2_Scl(0); 
		GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0004));   
		...
		{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->CRL&=0XFFFFF0FF;((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->CRL|=0X00000800;};
		Wait_PS2_Scl(0);
		if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),((uint16_t)0x0004))==0) Wait_PS2_Scl(1);
		   else 
		      {
			  PS2_En_Data_Report();
			  return 1;
