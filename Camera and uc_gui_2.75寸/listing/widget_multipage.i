#line 1 "..\\code\\Test ucGUI\\WIDGET_Multipage.c"
...
#line 21 "..\\code\\Test ucGUI\\WIDGET_Multipage.c"
...
#line 22 "..\\code\\Test ucGUI\\WIDGET_Multipage.c"
#line 1 "..\\code\\GUI\\GUI_inc\\MULTIPAGE.h"
...
#line 24 "..\\code\\GUI\\GUI_inc\\MULTIPAGE.h"
...
#line 25 "..\\code\\GUI\\GUI_inc\\MULTIPAGE.h"
...
typedef signed short MULTIPAGE_Handle;
...
MULTIPAGE_Handle MULTIPAGE_CreateEx      (int x0, int y0, int xsize, int ysize, GUI_HWIN hParent,
                                          int WinFlags, int ExFlags, int Id);
...
#line 23 "..\\code\\Test ucGUI\\WIDGET_Multipage.c"
...
#line 24 "..\\code\\Test ucGUI\\WIDGET_Multipage.c"
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate1[] = {
  { WINDOW_CreateIndirect,    "Dialog 1", 0,                   0,   0, 260, 100, (1<<4) },
  { BUTTON_CreateIndirect,    "Return",   0x170,      5,  30,  80,  20, 0},
  { TEXT_CreateIndirect,      "Dialog 1", 0,                   5,  10,  50,  20, (0<<0) }
};

static const GUI_WIDGET_CREATE_INFO _aDialogCreate2[] = {
  { WINDOW_CreateIndirect,    "Dialog 2", 0,                   0,   0, 260, 100, (1<<4) },
  { CHECKBOX_CreateIndirect,  "",         0x120,       5,  30,   0,   0, 0},
  { CHECKBOX_CreateIndirect,  "",         0x121,       5,  50,   0,   0, 0},
  { TEXT_CreateIndirect,      "Select 0", 0x160,       25,  30,  50,  15, (0<<0) },
  { TEXT_CreateIndirect,      "Select 1", 0x161,       25,  50,  50,  15, (0<<0) },
  { TEXT_CreateIndirect,      "Dialog 2", 0,                   5,  10,  50,  20, (0<<0) }
};

static const GUI_WIDGET_CREATE_INFO _aDialogCreate3[] = {
  { WINDOW_CreateIndirect,    "Dialog 3", 0,                   0,   0, 260, 100, (1<<4) },
  { RADIO_CreateIndirect,     "",         0x150,       5,  30,   0,   0, 0, 3},
  { TEXT_CreateIndirect,      "Option 1", 0x160,       25,  30,  50,  15, (0<<0) },
  { TEXT_CreateIndirect,      "Option 2", 0x161,       25,  50,  50,  15, (0<<0) },
  { TEXT_CreateIndirect,      "Option 3", 0x162,       25,  70,  50,  15, (0<<0) },
  { TEXT_CreateIndirect,      "Dialog 3", 0,                   5,  10,  50,  20, (0<<0) }
};

static const GUI_WIDGET_CREATE_INFO _aDialogCreate4[] = {
  { WINDOW_CreateIndirect,    "Dialog 4", 0,                   0,   0, 260, 100, (1<<4) },
  { MULTIEDIT_CreateIndirect, "Text",     0x190,   5,  30, 200,  40  },
  { TEXT_CreateIndirect,      "Dialog 4", 0,                   5,  10,  50,  20, (0<<0) }
};

static const GUI_WIDGET_CREATE_INFO _aDialogCreate5[] = {
  { WINDOW_CreateIndirect,    "Dialog 5", 0,                   0,   0, 260, 100, (1<<4) },
  { SLIDER_CreateIndirect,    "",         0x130,      5,  30, 200,  40  },
  { TEXT_CreateIndirect,      "Dialog 5", 0,                   5,  10,  50,  20, (0<<0) }
};

static const GUI_WIDGET_CREATE_INFO _aDialogCreate6[] = {
  { WINDOW_CreateIndirect,    "Dialog 6", 0,                   0,   0, 260, 100, (1<<4) },
  { SCROLLBAR_CreateIndirect, "",         0x140,   5,  30, 200,  40  },
  { TEXT_CreateIndirect,      "Dialog 6", 0,                   5,  10,  50,  20, (0<<0) }
};
...
static void _cbDialog4(WM_MESSAGE * pMsg) {
  ...
  switch (pMsg->MsgId) {
  case 30:
    hItem = WM_GetDialogItem(hDlg, 0x190);
...
static void _DemoMultiPage(void) {
  GUI_HWIN hMultiPage,hFrameWin,hDialog;
   
  WM_SetCreateFlags((1<<2));
  WM_EnableMemdev(WM_GetDesktopWindow());
  WM_SetCallback(WM_GetDesktopWindow(), &_cbBkWindow);  
   
  hFrameWin = FRAMEWIN_Create("FrameWindow", &_cbFrameWin, (1<<1), 40, 44, 240, 152);
  FRAMEWIN_SetActive(hFrameWin, 1);
  FRAMEWIN_SetMoveable(hFrameWin, 1);
   
  hMultiPage = MULTIPAGE_CreateEx(7, 6, 220, 120, WM_GetClientWindow(hFrameWin), (1<<1), 0, 0);
  
   
  hDialog = GUI_CreateDialogBox(_aDialogCreate1, 
                                (sizeof(_aDialogCreate1) / sizeof(_aDialogCreate1[0])), 
                                &_cbDialog1, ((signed short)-1), 0, 0);
  MULTIPAGE_AddPage(hMultiPage, hDialog, "Page 1");
  
  hDialog = GUI_CreateDialogBox(_aDialogCreate2, 
                                (sizeof(_aDialogCreate2) / sizeof(_aDialogCreate2[0])), 
                                &_cbDialog2, ((signed short)-1), 0, 0);
  MULTIPAGE_AddPage(hMultiPage, hDialog, "Page 2");
  
  hDialog = GUI_CreateDialogBox(_aDialogCreate3, 
                                (sizeof(_aDialogCreate3) / sizeof(_aDialogCreate3[0])), 
                                &_cbDialog3, ((signed short)-1), 0, 0);
  MULTIPAGE_AddPage(hMultiPage, hDialog, "Page 3");
  
  hDialog = GUI_CreateDialogBox(_aDialogCreate4, 
                                (sizeof(_aDialogCreate4) / sizeof(_aDialogCreate4[0])), 
                                &_cbDialog4, ((signed short)-1), 0, 0);
  MULTIPAGE_AddPage(hMultiPage, hDialog, "Page 4");
  
  hDialog = GUI_CreateDialogBox(_aDialogCreate5, 
                                (sizeof(_aDialogCreate5) / sizeof(_aDialogCreate5[0])), 
                                &_cbDialog5, ((signed short)-1), 0, 0);
  MULTIPAGE_AddPage(hMultiPage, hDialog, "Page 5");
  
  hDialog = GUI_CreateDialogBox(_aDialogCreate6, 
                                (sizeof(_aDialogCreate6) / sizeof(_aDialogCreate6[0])), 
                                &_cbDialog6, ((signed short)-1), 0, 0);
  MULTIPAGE_AddPage(hMultiPage, hDialog, "Page 6");
  
   
  MULTIPAGE_SetAlign(hMultiPage, (1<<0));
  
  MULTIPAGE_SetAlign(hMultiPage, (1<<0) | (1<<2));
  
  MULTIPAGE_SetAlign(hMultiPage, (0<<0) | (1<<2));
	Memu_Back=0;
  while (1) 
	{
		GUI_Exec();
