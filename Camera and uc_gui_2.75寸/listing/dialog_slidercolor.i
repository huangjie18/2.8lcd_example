#line 1 "..\\code\\Test ucGUI\\DIALOG_SliderColor.c"
...
#line 21 "..\\code\\Test ucGUI\\DIALOG_SliderColor.c"
...
#line 22 "..\\code\\Test ucGUI\\DIALOG_SliderColor.c"
...
#line 23 "..\\code\\Test ucGUI\\DIALOG_SliderColor.c"
...
#line 24 "..\\code\\Test ucGUI\\DIALOG_SliderColor.c"
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  { FRAMEWIN_CreateIndirect, "Adjust color", 0,         10,  40, 300, 160, (1<<4)},
  { TEXT_CreateIndirect,     "Red:" ,  0,                5,  20,  35,  20, (0<<0) },
  { TEXT_CreateIndirect,     "Green:", 0,                5,  50,  35,  20, (0<<0) },
  { TEXT_CreateIndirect,     "Blue:",  0,                5,  80,  35,  20, (0<<0) },
  { TEXT_CreateIndirect,     "Preview",0,              205,   4,  81,  15, (2<<0) },
  { SLIDER_CreateIndirect,   0,     0x130,  40,  20, 100,  20 },
  { SLIDER_CreateIndirect,   0,     0x131,  40,  50, 100,  20 },
  { SLIDER_CreateIndirect,   0,     0x132,  40,  80, 100,  20 },
  { EDIT_CreateIndirect,     0,     0x100,   145,  20,  30,  20, 0, 3 },
  { EDIT_CreateIndirect,     0,     0x101,   145,  50,  30,  20, 0, 3 },
  { EDIT_CreateIndirect,     0,     0x102,   145,  80,  30,  20, 0, 3 },
  { BUTTON_CreateIndirect,   "OK",     1,       10, 110,  60,  20 },
  { BUTTON_CreateIndirect,   "Cancel", 2,  230, 110,  60,  20 },
};
...
static unsigned char _aColorSep[3] = {0, 127, 255};   
...
static void _OnPaint(void) {
  ...
  GUI_SetColor(((unsigned long)_aColorSep[2]) << 16);
  GUI_FillRect(180, 80, 199, 99);
   
  GUI_SetColor(_aColorSep[0] | (((unsigned long)_aColorSep[1]) << 8) | (((unsigned long)_aColorSep[2]) << 16));
...
static void _OnValueChanged(GUI_HWIN hDlg, int Id) {
  unsigned Index, v;
  GUI_HWIN hSlider, hEdit;
  if ((Id >= 0x130) && (Id <= 0x132)) {
    Index = Id - 0x130;
     
    hSlider = WM_GetDialogItem(hDlg, 0x130 + Index);
    hEdit   = WM_GetDialogItem(hDlg, 0x100 + Index);
...
static void _cbCallback(WM_MESSAGE * pMsg) {
  ...
  switch (pMsg->MsgId) {
    ...
    case 30:
      for (i = 0; i < 3; i++) {
        hItem = WM_GetDialogItem(hDlg, 0x130 + i);
