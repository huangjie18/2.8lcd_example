#line 1 "..\\code\\user\\ucGUI_Practice.c"
...
#line 2 "..\\code\\user\\ucGUI_Practice.c"
void ucGUI_Practice(void)
{
	int tx,ty;
	...
	GUI_Context . LCD . aColorIndex16[0]=0xF800;
	GUI_DispStringAt("Dialog_All",0,30*0);
	while(1)
	{
		if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)),((uint16_t)0x0040))==1)
		{
			i++;
			if(i>7)i=0;
			LCD_delay(100);
			...
			GUI_Context . LCD . aColorIndex16[1]=0xFFE0;
			GUI_Context . LCD . aColorIndex16[0]=0x001F;
...
void Page_Init(unsigned char page_num)
{
	...
	{
		case 1:
			Lcd_ColorBox(0,0,400,240,0x001F);
			GUI_Context . LCD . aColorIndex16[1]=0xFFE0;
			GUI_Context . LCD . aColorIndex16[0]=0x001F;
			GUI_SetFont(&GUI_Font24_ASCII);
			GUI_DispStringAt("Dialog_All",0,30*0);
