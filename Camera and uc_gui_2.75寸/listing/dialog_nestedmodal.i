#line 1 "..\\code\\Test ucGUI\\DIALOG_NestedModal.c"
...
#line 21 "..\\code\\Test ucGUI\\DIALOG_NestedModal.c"
...
#line 22 "..\\code\\Test ucGUI\\DIALOG_NestedModal.c"
...
#line 23 "..\\code\\Test ucGUI\\DIALOG_NestedModal.c"
...
#line 24 "..\\code\\Test ucGUI\\DIALOG_NestedModal.c"
...
#line 25 "..\\code\\Test ucGUI\\DIALOG_NestedModal.c"
#line 1 "..\\code\\GUI\\GUI_inc\\MESSAGEBOX.h"
...
#line 24 "..\\code\\GUI\\GUI_inc\\MESSAGEBOX.h"
...
GUI_HWIN MESSAGEBOX_Create(const char * sMessage, const char * sCaption, int Flags);
...
#line 26 "..\\code\\Test ucGUI\\DIALOG_NestedModal.c"
...
#line 27 "..\\code\\Test ucGUI\\DIALOG_NestedModal.c"
...
static const GUI_WIDGET_CREATE_INFO _aDialogOrder[] = {
  ...
  { EDIT_CreateIndirect,     0,              0x100,      85,  10, 180,  20, 0, 40},
  { RADIO_CreateIndirect,    0,              0x150,     10,  50,   0,   0, 0, 0xF03 },
  { DROPDOWN_CreateIndirect, 0,              0x180, 135,  45, 130,  45, 0 },
  { DROPDOWN_CreateIndirect, 0,              0x181, 135,  75, 130,  45, 0 },
  { BUTTON_CreateIndirect,   "Select vehicle",  0x170,     6, 113, 100,  20, 0 },
  { BUTTON_CreateIndirect,   "OK",              1,        160, 113,  50,  20, 0 },
  { BUTTON_CreateIndirect,   "Cancel",          2,    217, 113,  50,  20, 0 }
};
...
static const GUI_WIDGET_CREATE_INFO _aDialogSelect[] = {
  ...
  { LISTVIEW_CreateIndirect, 0,              0x200,   7,  20, 190, 120, 0 },
  { BUTTON_CreateIndirect,   "OK",              1,         90, 153,  50,  20, 0 },
  { BUTTON_CreateIndirect,   "Cancel",          2,    147, 153,  50,  20, 0 }
};
...
static void _InitDialogSelect(GUI_HWIN hWin) {
  GUI_HWIN hItem;
  int i = 0;
  ...
  hItem = WM_GetDialogItem(hWin, 0x200);
  WM_SetScrollbarV(hItem, 1);
  LISTVIEW_SetGridVis(hItem, 1);
  LISTVIEW_SetLBorder(hItem, 3);
  LISTVIEW_SetRBorder(hItem, 3);
  LISTVIEW_AddColumn(hItem,  80, "Make",    (0<<0));
  LISTVIEW_AddColumn(hItem, 100, "Options", (0<<0));
...
static void _InitDialogOrder(GUI_HWIN hWin) {
  GUI_HWIN hItem;
  ...
  hItem = WM_GetDialogItem(hWin, 0x100);
  WM_DisableWindow(hItem);
   
  hItem = WM_GetDialogItem(hWin, 0x180);
  DROPDOWN_AddString(hItem, "Blue");
  DROPDOWN_AddString(hItem, "Green");
  DROPDOWN_AddString(hItem, "Red");
  DROPDOWN_SetBkColor(hItem, 1, 0xFFFFFF);
  DROPDOWN_SetTextColor(hItem, 1, 0x000000);
   
  hItem = WM_GetDialogItem(hWin, 0x181);
...
static int _GetVehicle(GUI_HWIN hWin) {
  GUI_HWIN hItem;
  int CurSel, NumItems;
  hItem = WM_GetDialogItem(hWin, 0x200);
...
static void _cbDialogSelect(WM_MESSAGE* pMsg) {
  ...
  case 30:
    ...
    WM_SetFocus(WM_GetDialogItem(hWin, 1));
    break;
  case 38:
    if (pMsg->Data.v == 2) {
...
static void _cbDialogOrder(WM_MESSAGE* pMsg) {
  ...
  case 38:
    if (pMsg->Data.v == 2) {
      ...
      switch (Id) {
      case 0x170:
        hDlg = GUI_CreateDialogBox(_aDialogSelect, (sizeof(_aDialogSelect) / sizeof(_aDialogSelect[0])), &_cbDialogSelect, WM_GetDesktopWindow(), 0, 0); 
        WM_MakeModal(hDlg);
        GUI_ExecCreatedDialog(hDlg);
        WM_MakeModal(hWin);
        WM_SetFocus(hWin);
        hDlg = WM_GetDialogItem(hWin, 0x100);
...
void DIALOG_NestedModal(void) {
  ...
  WM_SetCallback(WM_GetDesktopWindow(), &_cbBkWindow);
	hWin = GUI_CreateDialogBox(_aDialogOrder, (sizeof(_aDialogOrder) / sizeof(_aDialogOrder[0])), &_cbDialogOrder, WM_GetDesktopWindow(), 0, 0); 
	WM_MakeModal(hWin);
	GUI_ExecCreatedDialog(hWin);
}
