#line 1 "..\\code\\Test ucGUI\\WIDGET_ButtonRound.c"
...
#line 21 "..\\code\\Test ucGUI\\WIDGET_ButtonRound.c"
...
#line 22 "..\\code\\Test ucGUI\\WIDGET_ButtonRound.c"
...
#line 24 "..\\code\\Test ucGUI\\WIDGET_ButtonRound.c"
...
#line 25 "..\\code\\Test ucGUI\\WIDGET_ButtonRound.c"
...
#line 26 "..\\code\\Test ucGUI\\WIDGET_ButtonRound.c"
#line 1 "..\\code\\GUI\\GUI_inc\\BUTTON_Private.h"
...
#line 24 "..\\code\\GUI\\GUI_inc\\BUTTON_Private.h"
#line 25 "..\\code\\GUI\\GUI_inc\\BUTTON_Private.h"
...
#line 41 "..\\code\\GUI\\GUI_inc\\BUTTON_Private.h"
...
#line 27 "..\\code\\Test ucGUI\\WIDGET_ButtonRound.c"
#line 1 "..\\code\\GUI\\GUI_inc\\GUI_Protected.h"
...
#line 28 "..\\code\\Test ucGUI\\WIDGET_ButtonRound.c"
...
#line 29 "..\\code\\Test ucGUI\\WIDGET_ButtonRound.c"
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  { FRAMEWIN_CreateIndirect, "Round button sample", 0,      50,  60, 200, 120, (1<<4) },
  { BUTTON_CreateIndirect,   "Button",   0x170,   100,  10,  80,  80 },
  { BUTTON_CreateIndirect,   "Callback", 0x171,    10,  10,  60,  20 },
  { BUTTON_CreateIndirect,   "Font",     0x172,    10,  30,  60,  20 },
  { BUTTON_CreateIndirect,   "Color",    0x173,    10,  50,  60,  20 },
  { BUTTON_CreateIndirect,   "Return",   2,     10,  70,  60,  20 }
};
...
static void _OnPaint(BUTTON_Handle hObj) {
  ...
  GUI_RECT Rect;
  BUTTON_Obj * pObj;
  pObj = (BUTTON_Obj*) GUI_ALLOC_h2p(hObj);
  Index = (WIDGET_GetState(hObj) & (1<<8)) ? 1 : 0;
  ...
  GUI_DispStringInRect(ac, &Rect, (2<<0) | (3<<2));
}
...
static void _cbDialog(WM_MESSAGE *pMsg) {
  ...
  switch (pMsg->MsgId) {
    case 0x000F:
      ...
      break;
    case 30:
      hButton = WM_GetDialogItem(hDlg, 0x170);
        ...
        case 2:       
          ...
          if (Id == 0x173) {        
            if (_Color) {
              ...
              BUTTON_SetBkColor(hButton, 1, 0xFFFFFF);
              BUTTON_SetTextColor(hButton, 0, 0x000000);
              BUTTON_SetTextColor(hButton, 1, 0x000000);
            } else {
              BUTTON_SetBkColor(hButton, 0, 0xFF0000);
              BUTTON_SetBkColor(hButton, 1, 0x0000FF);
              BUTTON_SetTextColor(hButton, 0, 0xFFFFFF);
              BUTTON_SetTextColor(hButton, 1, 0x00FFFF);
            }
            _Color ^= 1;
          }
          if (Id == 1) {             
...
void MainTask_WIDGET_ButtonRound(void) {
  ...
  WM_SetDesktopColor(0x00FF00);
	_Font = 0;
	_Color = 0;
	_pcbCallback = 0;
	WM_SetCallback(WM_GetDesktopWindow(), _cbDesktop);
	GUI_ExecDialogBox(_aDialogCreate, (sizeof(_aDialogCreate) / sizeof(_aDialogCreate[0])), &_cbDialog, 0, 0, 0);
}
