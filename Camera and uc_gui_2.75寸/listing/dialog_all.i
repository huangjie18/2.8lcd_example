#line 1 "..\\code\\Test ucGUI\\Dialog_All.c"
...
#line 24 "..\\code\\Test ucGUI\\Dialog_All.c"
...
#line 25 "..\\code\\Test ucGUI\\Dialog_All.c"
...
#line 26 "..\\code\\Test ucGUI\\Dialog_All.c"
#line 27 "..\\code\\Test ucGUI\\Dialog_All.c"
...
#line 28 "..\\code\\Test ucGUI\\Dialog_All.c"
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  { FRAMEWIN_CreateIndirect, "Dialog", 0,                 30,   5, 260, 230, (1<<4), 0  },
  { BUTTON_CreateIndirect,   "OK",     1,        100,   5,  60,  20 },
  { BUTTON_CreateIndirect,   "Cancel", 2,    100,  30,  60,  20 },
  { TEXT_CreateIndirect,     "LText",  0,                 10,  55,  48,  15, (0<<0)  },
  { TEXT_CreateIndirect,     "RText",  0,                 10,  80,  48,  15, (1<<0) },
  { EDIT_CreateIndirect,     0,     0x100,      60,  55, 100,  15, 0, 50 },
  { EDIT_CreateIndirect,     0,     0x101,      60,  80, 100,  15, 0, 50 },
  { TEXT_CreateIndirect,     "Hex",    0,                 10, 100,  48,  15, (1<<0) },
  { EDIT_CreateIndirect,     0,     0x102,      60, 100, 100,  15, 0, 6 },
  { TEXT_CreateIndirect,     "Bin",    0,                 10, 120,  48,  15, (1<<0) },
  { EDIT_CreateIndirect,     0,     0x103,      60, 120, 100,  15 },
  { LISTBOX_CreateIndirect,  0,     0x110,   10,  10,  60,  40 },
  { CHECKBOX_CreateIndirect, 0,     0x120,     10, 140,   0,   0 },
  { CHECKBOX_CreateIndirect, 0,     0x121,     30, 140,   0,   0 },
  { SLIDER_CreateIndirect,   0,     0x130,    60, 140, 180,  20 },
  { SLIDER_CreateIndirect,   0,     0x131,    10, 170, 230,  30 },
  { DROPDOWN_CreateIndirect,  0,    0x180, 170,  10,  80,  60, 0, 3  },
  { DROPDOWN_CreateIndirect,  0,    0x181, 170,  60,  80,  60, 0, 3  }
};
...
static void _cbCallback(WM_MESSAGE * pMsg) {
  int NCode, Id;
  GUI_HWIN hEdit0, hEdit1, hEdit2, hEdit3, hListBox, hDropd0, hDropd1;
  GUI_HWIN hWin = pMsg->hWin;
  switch (pMsg->MsgId) {
    case 30:
       
      hEdit0   = WM_GetDialogItem(hWin, 0x100);
      hEdit1   = WM_GetDialogItem(hWin, 0x101);
      hEdit2   = WM_GetDialogItem(hWin, 0x102);
      hEdit3   = WM_GetDialogItem(hWin, 0x103);
      hListBox = WM_GetDialogItem(hWin, 0x110);
      hDropd0  = WM_GetDialogItem(hWin, 0x180);
      hDropd1  = WM_GetDialogItem(hWin, 0x181);
       
      EDIT_SetText(hEdit0, "EDIT widget 0");
      EDIT_SetText(hEdit1, "EDIT widget 1");
      EDIT_SetTextAlign(hEdit1, (0<<0));
      EDIT_SetHexMode(hEdit2, 0x1234, 0, 0xffffff);
      EDIT_SetBinMode(hEdit3, 0x1234, 0, 0xffff);
      LISTBOX_SetText(hListBox, _apListBox);
      WM_DisableWindow (WM_GetDialogItem(hWin, 0x121));
      CHECKBOX_SetState(WM_GetDialogItem(hWin, 0x120), 1);
      CHECKBOX_SetState(WM_GetDialogItem(hWin, 0x121), 1);
      SLIDER_SetWidth( WM_GetDialogItem(hWin, 0x130), 5);
      SLIDER_SetValue( WM_GetDialogItem(hWin, 0x131), 50);
      SCROLLBAR_CreateAttached(hListBox, (1<<3));
