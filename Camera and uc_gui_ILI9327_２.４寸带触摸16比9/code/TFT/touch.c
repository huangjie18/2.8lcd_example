...
unsigned int TOUCH_X(void)
{
	...
	if(i<300||i>3900)return 800;
		else return (3900-i)*4/(39-3);//2011年6月3日之后的屏用3850-350或3600-1000，之前的屏用3850-150
} 
unsigned int TOUCH_Y(void)
{
	unsigned int i;
	i=GUI_TOUCH_X_MeasureY();
	if(i<200||i>3800)return 800;
		else return (3800-i)*24/(380-20);
}
